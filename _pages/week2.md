...
However, genomic sharing can be realized in different ways depending on the probabilities \\(\pi_0\\), \\(\pi_1\\), and \\(\pi_2\\) that individuals share zero, one, or two copies IBD at a locus.  The probability that the relatives inherit both both copies IBD\\[\pi_2=P\left(\text{share 2 IBD})=\frac{1}{2^{R_1}}\times\frac{1}{2^{R_2}}\tag{3a}\\] is simply the product of the probabilities of sharing through both parents. The probability of sharing exactly one allele IBD\\[\pi_1=\P\left(\text{share 1 IBD}\right)=\frac{1}{2^{R_1}}+\frac{1}{2^{R_2}}-2\times\frac{1}{2^{R_1}\times\frac{2^{R_2}\tag{3b}\\] is the got by finding the probability \\(\frac{1}{2^{R_1}}+\frac{1}{2^{R_2}}-\frac{1}{2^{R_1}}\times\frac{1}{2^{R_2}}\\) of sharing at least one allele IBD less the probability \\(\pi_2\\) of sharing 2.  Finally, the probability of sharing at zero alleles IBD\\[\pi_0=P\left(\text{share 0 IBD}\right)=1-\frac{1}{2^{R_1}}-\frac{1}{2^{R_2}}+\frac{1}{2^{R_1}}\times\frac{1}{2^{R_2}}\tag{3c}\\]is got by subtracting the probability \\(\pi_1+\pi_2\\) of sharing at least one allele IBD from 1.

From (3a)&ndash;(3c), the fraction of the genome shared IBD is\\[r=2\pi_2+1\pi=\frac{1}{2^{R_1}}+\frac{1}{2^{R_2}}=\frac{1}{2^R}\tag{4}\\]_
